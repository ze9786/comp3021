...
//        return String.format("%02d:%02d", minutes, seconds);
    ...
    private void bindTo(StringProperty levelNameProperty, IntegerProperty timerProperty, IntegerProperty numMovesProperty, IntegerProperty numRestartsProperty) {
        //TODO
        levelNameLabel.textProperty().bind(Bindings.createStringBinding(()->("Level: "+levelNameProperty.getValue())));
        timerLabel.textProperty().bind(Bindings.createStringBinding(()->("Time: "+format(timerProperty.getValue())), timerProperty));
        numMovesLabel.textProperty().bind(Bindings.createStringBinding(()->("Moves: "+numMovesProperty.getValue()), numMovesProperty));
        numRestartsLabel.textProperty().bind(Bindings.createStringBinding(()->("Restarts: "+numRestartsProperty.getValue())));
    }
}
